      ...
      <div className="w-full max-w-[440px] relative z-10 space-y-8">
        ...
        <div className="flex flex-col items-center space-y-6">
          ...
          <div className="text-center space-y-1">
            <h1 className="text-5xl font-serif tracking-[0.05em] text-[var(--text-primary)] uppercase italic">
              BOSS
            </h1>
            <p className="text-[10px] text-[var(--gold)] font-bold uppercase tracking-[0.5em] opacity-80">
              ESTATE MANAGEMENT
            </p>
          </div>
        </div>
        ...
        {/* System Footer */}
        <p className="text-center text-[9px] font-bold text-[var(--text-muted)] uppercase tracking-[0.3em] opacity-40">
