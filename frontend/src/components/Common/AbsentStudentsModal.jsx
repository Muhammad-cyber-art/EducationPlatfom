...
const AbsentStudentsModal = ({ isOpen, onClose, branchId }) => {
 ...
 <div>
 <h3 className="text-base sm:text-lg font-black capitalize tracking-tight text-[var(--text-primary)]">Bugun Kelmaganlar</h3>
 <p className="text-[9px] font-black text-[var(--gold)]/80 capitalize tracking-widest mt-0.5">Davomat Nazorati</p>
 </div>
 </div>
 ...
 <span className="hidden sm:inline text-[9px] font-black capitalize tracking-widest">Excel</span>
 </button>
 ...
 className="w-full bg-[var(--bg-panel)] border border-[var(--border-glass)] focus:border-[var(--gold)]/50 rounded-xl py-2.5 pl-10 pr-3 text-[11px] sm:text-xs font-bold text-[var(--text-primary)] placeholder:text-[var(--text-muted)] outline-none transition-all capitalize tracking-wider"
 />
 </div>
 </div>
 ...
 <div>
 <p className="text-[11px] font-black text-[var(--text-primary)] capitalize tracking-tight">{student.name}</p>
 <p className="text-[8px] text-[var(--text-muted)] font-black capitalize tracking-widest mt-0.5">{student.group}</p>
 </div>
 </div>
 </div>
 {student.phone && (
 ...
 <p className="text-xs sm:text-sm font-black capitalize tracking-widest text-[var(--text-primary)] mb-1">Ma'lumot topilmadi</p>
 ...
 <button
 onClick={onClose}
 className="px-6 py-2.5 bg-[var(--bg-void)] border border-[var(--border-glass)] hover:bg-[var(--gold)]/10 hover:text-[var(--gold)] hover:border-[var(--gold)]/30 rounded-xl text-[10px] font-black capitalize tracking-widest transition-all active:scale-95"
 >
 Yopish
 </button>
 </div>
