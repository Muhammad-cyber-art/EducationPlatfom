...
const SendMessageModal = ({ isOpen, onClose, groupId = null, branchId = null, showGlobalOption = false }) => {
 ...
 <p className="text-[12px] font-bold text-slate-500 mt-2 capitalize tracking-[1.5px]">
 ...
 <label className="text-[11px] font-black text-slate-400 capitalize tracking-[2px] ml-1">
 ...
 type="button"
 onClick={onClose}
 className="flex-1 py-4 text-sm font-black text-slate-400 hover:text-black capitalize tracking-widest transition-colors"
 >
 Bekor qilish
 </button>
 <button
 ...
 className="flex-[1.5] py-5 bg-black hover:bg-slate-800 text-white rounded-2xl text-sm font-black capitalize tracking-widest shadow-xl shadow-slate-200 transition-all active:scale-[0.97] disabled:opacity-30 disabled:cursor-not-allowed flex items-center justify-center gap-3"
 >
 {loading ? (
