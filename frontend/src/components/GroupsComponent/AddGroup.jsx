      ...
      <div className="max-w-3xl mx-auto px-4 py-8 md:py-12 relative z-10">
        ...
        <div className="flex items-center justify-between gap-6 mb-8 pb-6 border-b border-[var(--border-glass)]">
          <div className="flex items-center gap-4">
            <GoBackButton />
            <div>
              <h1 className="text-xl md:text-2xl font-black text-[var(--text-primary)] uppercase tracking-tight">Guruh ochish</h1>
              <div className="flex items-center gap-2 mt-1">
                <span className="text-[9px] font-black text-[var(--gold)] tracking-widest uppercase">Yangi tarkib</span>
                <span className="w-1 h-1 rounded-full bg-[var(--border-glass)]"></span>
                <p className="text-[9px] text-[var(--text-muted)] font-bold uppercase tracking-widest font-sans">Formalar xizmati</p>
              </div>
            </div>
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="lux-card !p-5 md:!p-8 !rounded-2xl border-l-4 border-l-[var(--gold)]/30">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h3 className="text-[11px] font-black text-[var(--text-primary)] uppercase tracking-[0.2em]">Asosiy Ma'lumotlar</h3>
            </div>

            <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 gap-5">
              <div className="space-y-1.5 w-full">
                <label className="text-[9px] font-bold text-[var(--text-muted)] uppercase tracking-widest ml-1">Guruh Nomi</label>
                <input
              ...
              <div className="space-y-1.5 w-full">
                <label className="text-[9px] font-bold text-[var(--text-muted)] uppercase tracking-widest ml-1">Fan Yo'nalishi</label>
                <input
                  onChange={handleChange}
                  name="subject"
                  type="text"
              ...
              <div className="space-y-1.5 w-full">
                <label className="text-[9px] font-bold text-[var(--text-muted)] uppercase tracking-widest ml-1">Mentor </label>
                <select
                  onChange={handleChange}
                  name="mentor_id"
                  required
              ...
              <div className="space-y-1.5 w-full">
                <label className="text-[9px] font-bold text-[var(--text-muted)] uppercase tracking-widest ml-1">Boshlanish Sanasi</label>
                <input
                  onChange={handleChange}
                  name="start_date"
                  type="date"
          ...
          <div className="lux-card !p-5 md:!p-8 !rounded-2xl border-l-4 border-l-purple-500/30">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h3 className="text-[11px] font-black text-[var(--text-primary)] uppercase tracking-[0.2em]">Taqvim va To'lov</h3>
            </div>

            <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 gap-5">
              <div className="space-y-1.5 w-full">
                <label className="text-[9px] font-bold text-[var(--text-muted)] uppercase tracking-widest ml-1">Hafta Kunlari</label>
                <select
                  name="days"
                  onChange={handleChange}
                  className="lux-input !bg-[var(--bg-void)] w-full"
              ...
              <div className="space-y-1.5 w-full">
                <label className="text-[9px] font-bold text-[var(--text-muted)] uppercase tracking-widest ml-1">Mashg'ulot Vaqti</label>
                <input
                  onChange={handleChange}
                  name="dars_vaqti"
                  type="text"
              ...
              <div className="space-y-1.5 w-full">
                <label className="text-[9px] font-bold text-[var(--text-muted)] uppercase tracking-widest ml-1">Oylik To'lov Summasi</label>
              ...
              <div className="space-y-1.5 w-full">
                <label className="text-[9px] font-bold text-[var(--text-muted)] uppercase tracking-widest ml-1">Dars Kunlari (Ismlar)</label>
                <input
                  onChange={handleChange}
                  name="dars_kunlari"
                  type="text"
          ...
          <div className="lux-card !p-5 md:!p-8 !rounded-2xl border-l-4 border-l-emerald-500/30">
            <div className="flex items-center gap-3 mb-5">
              ...
              <h3 className="text-[11px] font-black text-[var(--text-primary)] uppercase tracking-[0.2em]">Qo'shimcha Izoh</h3>
            </div>
            <textarea
              onChange={handleChange}
              name="description"
          ...
          <div className="flex items-center justify-end gap-5 pt-4 pb-10">
            <button
              type="button"
              onClick={() => navigate(-1)}
              className="text-[10px] font-black text-[var(--text-muted)] uppercase tracking-widest hover:text-[var(--gold)] transition-colors"
            >
              Bekor qilish
            </button>
            <button
            ...
            >
              <span className="relative flex items-center gap-2 text-[11px] uppercase font-black">
