...
export default function GroupDetailPage() {
 ...
 // Data & Permissions
 const { groupinfo, groupStudents, botStats, permissions, userData, isGroupError } = useGroupDetails(group_id);
 const {
 ...
 const canEditAttendanceToday = permissions.canTakeAttendance && selectedDate === todayStr && isGroupLogicActive;
 ...
 <AttendanceSection
 {...{
 group_id, groupinfo, groupStudents, filteredStudents, selectedDate, availableDates,
 attendanceData, isAttendanceConfirmed, canEditAttendanceToday, isGroupLogicActive,
