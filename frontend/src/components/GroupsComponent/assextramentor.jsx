      ...
      >
        ...
        <div className="px-5 py-4 border-b border-[var(--border-glass)] flex items-center justify-between bg-[var(--bg-void)]">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-sm font-bold text-[var(--text-primary)] uppercase tracking-wide">Mentor biriktirish</h2>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="max-h-[300px] overflow-y-auto p-0">
          {loading ? (
            <div className="py-10 flex flex-col items-center justify-center gap-2 text-[var(--text-secondary)]">
              ...
              <p className="text-[10px] font-bold uppercase tracking-widest opacity-60">Yuklanmoqda...</p>
            </div>
            ...
            <div className="divide-y divide-[var(--border-glass)]">
              {filteredMentors.map((mentor) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 rounded bg-[var(--bg-void)] border border-[var(--border-glass)] flex items-center justify-center text-[var(--text-primary)] font-bold text-xs uppercase">
            ...
            <div className="py-10 text-center space-y-2">
              ...
              <p className="text-[var(--text-secondary)] text-[10px] font-bold uppercase tracking-widest opacity-60">Mos mentorlar topilmadi</p>
            </div>
          )}
        </div>
        ...
        <div className="p-3 bg-[var(--bg-void)] border-t border-[var(--border-glass)]">
          <p className="text-[9px] text-center text-[var(--text-secondary)] font-bold uppercase tracking-[0.2em] opacity-50">
