...
export default function SuperAdminBottomNav() {
    ...
    return (
        <div className="md:hidden fixed bottom-0 left-0 right-0 h-14 bg-[var(--bg-panel)]/95 backdrop-blur-xl border-t border-[var(--border-glass)] flex items-center justify-around px-2 z-50">
            {menuItems.map((item) => {
