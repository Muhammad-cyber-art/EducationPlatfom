            ...
            <div className="bg-[var(--bg-void)] border border-[var(--border-glass)] rounded-[2.5rem] w-full max-w-lg max-h-[90vh] overflow-hidden shadow-2xl flex flex-col animate-in zoom-in-95 duration-200">
                ...
                <div className="p-6 border-b border-[var(--border-glass)] flex items-center justify-between bg-gradient-to-r from-amber-500/10 to-transparent">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="text-lg font-black text-[var(--text-primary)] uppercase tracking-tight">O'quvchilarni Birlashtirish</h2>
                            <p className="text-[10px] font-bold text-[var(--text-muted)] uppercase tracking-widest">Dublikat profillarni bittaga jamlash</p>
                        </div>
                    </div>
                ...
                <div className="p-6 space-y-6 overflow-y-auto">
                    ...
                    <div className="p-4 rounded-2xl bg-[var(--gold)]/5 border border-[var(--gold)]/20">
                        <p className="text-[9px] font-black text-[var(--gold)] uppercase tracking-widest mb-2">Asosiy Profil (Saqlanib qoladi)</p>
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h4 className="text-sm font-black text-[var(--text-primary)] uppercase">{masterStudent.full_name}</h4>
                    ...
                    <div className="space-y-4">
                        <label className="text-[10px] font-black text-[var(--text-muted)] uppercase tracking-widest ml-1">Dublikat profilni qidiring</label>
                        ...
                        <div className="space-y-2 max-h-[200px] overflow-y-auto scrollbar-thin pr-1">
                            {results.map((student) => (
                                ...
                                >
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            <h5 className="text-[11px] font-black text-[var(--text-primary)] uppercase">{student.full_name}</h5>
                            ...
                            {searchQuery && !loading && results.length === 0 && (
                                <p className="text-center py-4 text-[10px] font-bold text-[var(--text-muted)] uppercase italic">O'quvchi topilmadi</p>
                            )}
                        </div>
                    </div>
                    ...
                    {selectedStudent && (
                        <div className="p-4 rounded-xl bg-red-500/5 border border-red-500/20 flex gap-3 animate-in slide-in-from-top-2">
                            ...
                            <div>
                                <p className="text-[10px] font-black text-red-500 uppercase leading-tight">Diqqat!</p>
                ...
                <div className="p-6 border-t border-[var(--border-glass)] flex items-center gap-3">
                    <button
                        onClick={onClose}
                        className="flex-1 py-4 rounded-2xl border border-[var(--border-glass)] text-[10px] font-black uppercase tracking-widest text-[var(--text-secondary)] hover:bg-white/5 transition-all"
                    >
                        Bekor qilish
                    </button>
                    <button
                        ...
                        className="flex-[2] py-4 rounded-2xl bg-red-600 hover:bg-red-700 text-white text-[10px] font-black uppercase tracking-widest shadow-lg shadow-red-900/20 transition-all active:scale-[0.98] disabled:opacity-30 disabled:grayscale"
                    >
