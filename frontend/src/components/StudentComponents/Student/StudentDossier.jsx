...
import { Phone, FileText, Send, User, ShieldCheck, CreditCard, Save } from"lucide-react";
...
const StudentDossier = ({
 ...
 <span className="text-[10px] font-bold text-[var(--gold)] capitalize tracking-[0.3em]">Shaxsiy ma'lumotlar</span>
 </div>
 ...
 <div className="lux-card space-y-6">
 <div className="flex items-center gap-3 px-1">
 <span className="text-[10px] font-bold text-[var(--gold)] capitalize tracking-[0.3em]">Vasiy ma'lumotlari</span>
 </div>
 <div className="space-y-4">
 ...
 <div className="lux-card space-y-6">
 <div className="flex items-center gap-3 px-1">
 <span className="text-[10px] font-bold text-[var(--gold)] capitalize tracking-[0.3em]">Moliyaviy status</span>
 </div>
 <div className="space-y-4">
 <ProfileAttribute
