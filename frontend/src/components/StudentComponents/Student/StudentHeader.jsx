                        ...
                        {isEditing ? (
                            <>
                                <button 
                                    ...
                                    className="p-2 sm:p-2.5 text-emerald-500 hover:bg-emerald-500/10 rounded-lg transition-all" 
                                    title="Saqlash"
                                >
                                    <Save size={18} />
                                </button>
                            ...
                            <>
                                <button 
                                    ...
                                    className="p-2 sm:p-2.5 text-blue-500 hover:bg-blue-500/10 rounded-lg transition-all" 
                                    title="Tahrirlash"
                                >
                                    <Edit3 size={18} />
                                </button>
                                ...
                                {(userRole === 'admin' || userRole === 'super_admin') && (
                                    <button 
                                        ...
                                        className="p-2 sm:p-2.5 text-amber-500 hover:bg-amber-500/10 rounded-lg transition-all" 
                                        title="Birlashtirish"
                                    >
                                        <Layers size={18} />
                                    </button>
