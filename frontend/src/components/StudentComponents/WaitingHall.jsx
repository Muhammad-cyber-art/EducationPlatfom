        ...
        <div className="animate-lux-fade">
            ...
            {showAddModal && (
                <div className="fixed inset-0 z-[1000] flex items-center justify-center p-4">
                    ...
                    <div className="lux-card w-full max-w-md relative z-10 animate-in zoom-in-95 duration-300 flex flex-col p-0 overflow-hidden">
                        <div className="p-8 border-b border-[var(--border-glass)] bg-[var(--bg-void)]/50">
                            <div className="flex justify-between items-center">
                                <h3 className="text-xl font-black gold-text uppercase tracking-tighter">O'quvchi rejalashtirish</h3>
                                <button onClick={() => setShowAddModal(false)} className="text-[var(--text-muted)] hover:text-white"><X size={20} /></button>
                            </div>
                        </div>
                        <form onSubmit={handleAddStudent} className="p-8 space-y-6">
                            <div className="space-y-2">
                                <label className="text-[9px] font-black uppercase tracking-[0.2em] text-[var(--text-muted)] px-1">To'liq ismi</label>
                                <input
                                    autoFocus
                                    className="lux-input py-4 text-sm font-bold"
                            ...
                            <div className="space-y-2">
                                <label className="text-[9px] font-black uppercase tracking-[0.2em] text-[var(--text-muted)] px-1">Telefon raqami</label>
                                <input
                                    className="lux-input py-4 text-sm font-bold"
                            ...
                            <div className="space-y-2">
                                <label className="text-[9px] font-black uppercase tracking-[0.2em] text-[var(--text-muted)] px-1">Yo'nalish / Fan</label>
                                <input
                                    className="lux-input py-4 text-sm font-bold"
                            ...
                            <div className="space-y-2">
                                <label className="text-[9px] font-black uppercase tracking-[0.2em] text-[var(--text-muted)] px-1">Qisqa izoh</label>
                                <textarea
                                    className="lux-input py-4 text-sm font-bold min-h-[100px] resize-none"
                                    value={formData.notes}
                                    onChange={(e) => setFormData({ ...formData, notes: e.target.value })}
                                    placeholder="Xohishlari, darajasi va h.k."
                                />
                            </div>
                            <button
                                type="submit"
                                className="lux-btn lux-btn-primary w-full py-4 shadow-[var(--gold-glow)]"
                            >
                                <span className="text-[11px] font-black uppercase tracking-[0.3em]">Ro'yxatga Qo'shish</span>
                            </button>
                        </form>
                    </div>
                </div>
