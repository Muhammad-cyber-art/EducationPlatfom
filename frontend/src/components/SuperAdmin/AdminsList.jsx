      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 md:gap-6 pb-6 border-b border-[var(--border-glass)]">
        <div className="flex items-center gap-4 md:gap-6">
          ...
          <div>
            ...
            <p className="text-[9px] md:text-[10px] text-[var(--text-muted)] font-bold uppercase tracking-[0.2em] md:tracking-[0.3em] font-sans">
      ...
      <div className="relative min-h-[400px]">
        ...
        {loading && (
          <div className="flex flex-col items-center justify-center py-24 md:py-32 space-y-4">
            ...
            <p className="text-[9px] md:text-[10px] font-bold uppercase tracking-[0.3em] text-[var(--text-muted)]">Yuklanmoqda...</p>
          </div>
        )}
        ...
        {!loading && admin.length === 0 && (
          <div className="lux-card !p-10 md:!p-20 text-center border-dashed border-[var(--border-glass)] opacity-30 !rounded-3xl">
            ...
            <p className="text-xs md:text-sm font-bold uppercase tracking-widest italic text-[var(--text-primary)]">Administratorlar topilmadi</p>
            <p className="text-[9px] md:text-[10px] mt-2 font-bold uppercase tracking-widest">Ushbu filialda administratorlar mavjud emas.</p>
          </div>
        )}
