                ...
                <div className="p-6">
                    <div className="flex justify-between items-center mb-6">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h2 className="text-base font-black text-[var(--text-primary)] uppercase tracking-tight">Avans Berish</h2>
                                <p className="text-[10px] text-[var(--text-muted)] font-black uppercase tracking-widest">{staffName}</p>
                            </div>
                        </div>
                        <button
                            onClick={onClose}
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        <div>
                            <label className="text-[10px] font-black text-[var(--text-muted)] uppercase tracking-[0.2em] ml-1 mb-2 block">Avans Summasi (UZS)</label>
                            <div className="relative group">
                                ...
                                <AmountInput
                                    ...
                                    placeholder="0"
                                    className="w-full bg-[var(--bg-panel)] border border-[var(--border-glass)] rounded-2xl py-3.5 pl-12 pr-4 text-[var(--text-primary)] focus:outline-none focus:border-amber-500/50 transition-all font-black text-lg shadow-inner italic"
                                />
                            </div>
                        </div>

                        <div>
                            <label className="text-[10px] font-black text-[var(--text-muted)] uppercase tracking-[0.2em] ml-1 mb-2 block">Izoh (Ixtiyoriy)</label>
                            <div className="relative group">
                        ...
                        <div className="pt-2">
                            <button
                                ...
                                className="w-full bg-amber-500 hover:bg-amber-600 text-black font-black py-4 rounded-2xl transition-all flex items-center justify-center gap-2 text-xs uppercase tracking-widest shadow-[0_0_30px_rgba(245,158,11,0.2)] active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed"
                            >
                                {loading ? <Loader2 className="animate-spin" size={18} /> : <Save size={18} />}
                                Tasdiqlash
                            </button>

                            <p className="text-center text-[9px] text-[var(--text-muted)] font-black uppercase mt-4 tracking-tighter">
