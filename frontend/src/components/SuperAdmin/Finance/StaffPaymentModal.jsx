      ...
      <div className="relative w-full max-w-[360px] overflow-hidden bg-[var(--bg-panel)] border border-[var(--border-glass)] rounded-2xl shadow-2xl shadow-indigo-500/10">
        ...
        <div className="p-5 md:p-7">
          ...
          <div className="text-center mb-6">
            <h2 className="text-xl font-black text-white mb-2 tracking-tight uppercase">To'lovni Tasdiqlash</h2>
            <div className="bg-slate-900/50 border border-[var(--border-glass)] p-3 rounded-xl mb-4">
              <p className="text-[8px] font-black text-slate-600 uppercase tracking-[0.3em] mb-1">Xodim</p>
              <p className="text-sm font-black text-indigo-300 uppercase italic">
          ...
          <div className="space-y-4 mb-8">
            <div className="grid grid-cols-2 gap-3">
              <div className="space-y-1.5">
                <label className="text-[9px] font-black text-emerald-500 uppercase tracking-widest ml-1">Bonus (+)</label>
                <AmountInput
                  value={bonus || ""}
              ...
              <div className="space-y-1.5">
                <label className="text-[9px] font-black text-rose-500 uppercase tracking-widest ml-1">Jarima (-)</label>
                <AmountInput
                  value={deduction || ""}
            ...
            <div className="p-4 rounded-2xl bg-[var(--bg-void)] border border-indigo-500/20 shadow-inner">
              <div className="flex justify-between items-center mb-1">
                <span className="text-[10px] font-bold text-slate-500 uppercase tracking-tight">Kutilayotgan maosh:</span>
              ...
              <div className="flex justify-between items-center pt-2 border-t border-[var(--border-glass)]">
                <span className="text-xs font-black text-indigo-400 uppercase italic tracking-widest">Yakuniy Summa:</span>
          ...
          <div className="space-y-3">
            <button
              ...
              disabled={loading}
              className="w-full flex items-center justify-center gap-2 bg-indigo-600 hover:bg-indigo-500 disabled:bg-indigo-800 text-white font-black text-[11px] uppercase tracking-widest py-3.5 rounded-xl transition-all shadow-xl shadow-indigo-600/20 active:scale-95 disabled:opacity-50"
            >
              {loading ? (
                <>
            ...
            <button
              onClick={onClose}
              disabled={loading}
              className="w-full bg-transparent hover:bg-slate-800/30 text-slate-500 hover:text-slate-300 font-black text-[10px] uppercase tracking-[0.2em] py-2 transition-all rounded-lg"
            >
              Bekor qilish
            </button>
          </div>
          ...
          {/* Footer Info */}
          <div className="mt-6 flex items-center justify-center gap-2 text-[8px] text-slate-800 uppercase tracking-widest font-black border-t border-[var(--border-glass)] pt-5">
