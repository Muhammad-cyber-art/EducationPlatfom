...
const SuperAdminDashboard = () => {
 ...
 <div className="px-2 py-1 rounded-full text-[8px] font-black tracking-widest bg-emerald-500/10 text-emerald-500 border border-emerald-500/20 capitalize">
 Bugun
 </div>
 </div>
 <div>
 <p className="text-[8px] font-black text-[var(--text-muted)] capitalize tracking-[0.4em] mb-2">Davomat Ko'rsatkichi</p>
 <div className="flex items-end justify-between">
 <div>
 <h3 className="text-sm font-black text-[var(--text-primary)] capitalize tracking-widest">Bugungi Kelmaganlar</h3>
 </div>
 <div className="text-right">
 <p className="text-4xl font-black text-red-500 font-mono drop-shadow-[0_0_15px_rgba(239,68,68,0.3)]">
 {stats?.attendance_today?.absent || 0}
 </p>
 <p className="text-[7px] font-black text-red-500/60 capitalize tracking-widest mt-1">Kelmaganlar soni</p>
 </div>
 </div>
 ...
 <div>
 <h3 className="text-xl font-black text-[var(--text-primary)] capitalize tracking-tight">Tezkor xabar yuborish</h3>
 <p className="text-[9px] font-black text-[var(--text-muted)] capitalize tracking-[0.3em] mt-1">Telegram bot orqali barchaga xabar yuborish</p>
 </div>
 </div>
 ...
 <span className="text-[10px] font-black capitalize tracking-widest">{isGlobal ?"Barchaga xabar yozish" :"Kimlarga xabar yuborilsin?"}</span>
 </div>
 </div>
 ...
 className="w-full bg-[var(--bg-void)]/40 border border-[var(--border-glass)] focus:border-[var(--gold)]/50 rounded-2xl p-6 text-sm font-bold text-[var(--text-primary)] placeholder:text-[var(--text-muted)] outline-none transition-all min-h-[160px] resize-none shadow-inner capitalize tracking-wide"
 />
 ...
 <span className="text-[11px] font-black capitalize tracking-[0.2em] relative z-10">{loading ?"Yuborilmoqda..." :"Xabarni yuborish"}</span>
 </button>
 </div>
 </div>
 </div>
 ...
 <h4 className="text-[10px] font-black text-[var(--text-primary)] capitalize tracking-[0.4em]">Umumiy tahlillar</h4>
...
const StatCard = ({ onClick, title, value, icon, trend, delay, variant ="default", actionButton }) => {
 ...
 <div>
 <p className="text-[8px] font-black text-[var(--text-muted)] capitalize tracking-[0.4em] mb-2 group-hover:translate-x-1 transition-transform">{variant ==="gold" ?"Bot Statistikasi" :"Statistika"}</p>
 <div className="flex items-baseline gap-2">
 <h3 className="text-sm font-black text-[var(--text-primary)] capitalize tracking-widest">{title}</h3>
 {value !== undefined && <span className="text-xl font-black text-[var(--gold)]">{value}</span>}
 </div>
 </div>
 </div>
 );
