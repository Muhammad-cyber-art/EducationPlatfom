      ...
      <div className="p-4 md:p-8 max-w-lg mx-auto space-y-8 mt-4 md:mt-10">
        ...
        <div className="flex items-center gap-5">
          ...
          <div>
            ...
            <p className="text-[10px] md:text-xs text-[var(--gold)] font-black uppercase tracking-[0.2em]">{user_info.username || "superadmin"}</p>
          </div>
        </div>
        ...
        <div className="space-y-4 pt-6 border-t border-[var(--border-glass)]">
          ...
          <button
            ...
            className="w-full py-4 bg-[var(--gold)] hover:bg-[var(--gold)]/90 text-black border border-[var(--gold)]/50 rounded-2xl text-[12px] md:text-sm font-black uppercase tracking-widest transition-all shadow-lg shadow-[var(--gold)]/20 active:scale-95 flex items-center justify-center gap-3"
          >
            <Send size={18} />
          ...
          <div className="flex items-center justify-between py-2 border-b border-[var(--border-glass)] mt-4">
            <div className="flex items-center gap-3 text-[var(--text-secondary)]">
              <Phone size={16} />
              <span className="text-[12px] md:text-sm font-medium italic">Telefon raqam</span>
            </div>
          ...
          <button
            onClick={LogOut}
            className="w-full py-3 bg-red-500/10 hover:bg-red-500 text-red-500 hover:text-white border border-red-500/20 rounded-xl text-[12px] md:text-sm font-black uppercase tracking-widest transition-all shadow-lg shadow-red-900/5 active:scale-95 mt-4"
          >
