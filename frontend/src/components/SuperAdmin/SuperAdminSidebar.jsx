...
export default function SuperAdminSidebar() {
 ...
 SUPER <span className="text-[var(--gold)] font-light">ADMIN</span>
 </h1>
 <p className="text-[9px] text-[var(--text-muted)] font-black capitalize tracking-[0.35em] mt-1.5 opacity-60">Global Control</p>
 </div>
 </div>
