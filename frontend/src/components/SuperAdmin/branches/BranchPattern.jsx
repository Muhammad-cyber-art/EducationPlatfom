    ...
    <div className="flex flex-col min-h-screen bg-[var(--bg-void)] text-[var(--text-primary)] font-sans">
      ...
      <main className="flex-1 flex flex-col min-w-0">
          ...
          <div className="flex items-center justify-between px-4 md:px-6">
            ...
            <div className="flex-1 flex overflow-x-auto py-2 md:py-3 gap-2 scrollbar-hide items-center">
              ...
              {branches.map((branch) => {
                ...
                return (
                  <button
                    ...
                    className={`shrink-0 px-3 py-1.5 md:px-4 md:py-2 rounded-lg text-[9px] md:text-[10px] font-black uppercase transition-all flex items-center gap-2 border
                      ${isActive
              ...
              <div className="flex items-center gap-2 pl-2 md:pl-4 border-l border-[var(--border-glass)] ml-2">
                ...
                >
                  <ArrowLeftRight size={14} className="group-hover:scale-110 transition-transform" /> <span className="hidden md:inline ps-2 text-[9px] font-black uppercase tracking-wider">Xodim transfer qilish</span>
                </button>
                ...
                >
                  <Plus size={14} />
                  <span className="hidden md:inline text-[9px] font-black uppercase tracking-wider">Yangi filial</span>
                </button>
              </div>
            </div>
        ...
        <div className="px-4 md:px-10 py-2.5 md:py-4 flex items-center gap-2 flex-wrap border-b border-[var(--border-glass)] bg-[var(--bg-void)]/50">
          <div className="flex items-center gap-1.5 text-[8.5px] md:text-[9.5px] font-black uppercase tracking-[0.15em] text-[var(--text-secondary)]">
            <LayoutGrid size={10} className="mb-0.5" /> Boshqaruv
          </div>
          <ChevronRight size={10} className="text-[var(--text-muted)]" />
          <div className="text-[8.5px] md:text-[9.5px] font-black uppercase tracking-[0.15em] text-[var(--gold)]">
