                ...
                >
                    ...
                    <div className="flex-1 text-center sm:text-left min-w-0">
                        <div className="space-y-1 md:space-y-1.5">
                            <h3 className="text-lg md:text-xl lg:text-2xl font-black text-[var(--text-primary)] uppercase tracking-tight leading-tight">
                            ...
                            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[var(--gold-dim)] border border-[var(--gold)]/20">
                                ...
                                <span className="text-[9px] md:text-[10px] font-black text-[var(--gold)] uppercase tracking-[0.2em]">
            ...
            {colorCh && (
                ...
                >
                    <div className="mb-6 text-center">
                        <p className="text-[10px] font-black text-[var(--gold)] uppercase tracking-[0.5em] mb-2">Rangni Tanlash</p>
                    ...
                    <div className="flex flex-col items-center gap-6 w-full max-w-[240px]">
                        ...
                        <div className="flex gap-3 w-full">
                            <button
                                ...
                                disabled={loading}
                                className="lux-btn lux-btn-primary flex-1 !h-12 !rounded-2xl !text-[11px] uppercase font-black"
                            >
