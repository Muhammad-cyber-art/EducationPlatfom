        ...
        <div className="min-h-screen bg-[var(--bg-void)] relative overflow-hidden flex flex-col pt-4 md:pt-0">
            ...
            <div className="sticky top-0 z-50 bg-[var(--bg-panel)]/40 backdrop-blur-2xl border-b border-[var(--border-glass)] px-6 md:px-10 py-4 flex items-center justify-between shadow-xl">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-lg font-black text-[var(--text-primary)] uppercase tracking-tight italic">To‘lovlar Tarixi</h1>
                        <p className="text-[9px] font-black text-[var(--text-secondary)] uppercase tracking-[0.3em] opacity-40">Moliyaviy Yozuvlar</p>
                    </div>
                </div>
                <button className="flex items-center gap-2.5 px-5 py-2.5 bg-[var(--gold)] hover:bg-[var(--gold)]/90 text-black rounded-xl transition-all text-[11px] font-black uppercase tracking-widest shadow-xl shadow-[var(--gold)]/20 active:scale-95 group overflow-hidden relative">
                ...
                <div className="group relative overflow-hidden rounded-[2.5rem] border border-[var(--border-glass)] bg-[var(--bg-panel)]/40 backdrop-blur-3xl p-8 shadow-3xl shadow-[var(--shadow-color)] transition-all duration-500">
                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                        <div className="space-y-2">
                            <p className="text-[10px] font-black text-[var(--text-secondary)] uppercase tracking-[0.3em] opacity-60">O'quvchi</p>
                            <h2 className="text-3xl font-black text-[var(--text-primary)] tracking-tighter italic uppercase">{studentData.name}</h2>
                        </div>
                        <div className="flex flex-col items-end gap-1">
                            <p className="text-[11px] font-black text-[var(--gold)] uppercase tracking-widest bg-[var(--gold-dim)] px-4 py-1.5 rounded-full border border-[var(--gold)]/20 shadow-lg shadow-[var(--gold)]/5">
                                {studentData.group}
                            </p>
                            <p className="mr-4 text-[9px] font-black text-[var(--text-secondary)] uppercase tracking-[0.4em] opacity-40">ID: {studentData.groupId}</p>
                        </div>
                    </div>
                </div>
                        ...
                        <table className="w-full">
                            <thead>
                                <tr className="text-left text-[var(--text-secondary)] border-b border-[var(--border-glass)] bg-[var(--bg-void)]/30">
                                    <th className="px-8 py-5 text-[10px] font-black uppercase tracking-[0.3em] italic">Davr (Oy)</th>
                                    <th className="px-8 py-5 text-[10px] font-black uppercase tracking-[0.3em] italic">Miqdori</th>
                                    <th className="px-8 py-5 text-[10px] font-black uppercase tracking-[0.3em] italic">Sana</th>
                                    <th className="px-8 py-5 text-[10px] font-black uppercase tracking-[0.3em] italic text-center">Usul</th>
                                    <th className="px-8 py-5 text-[10px] font-black uppercase tracking-[0.3em] italic text-center">Holati</th>
                                </tr>
                            </thead>
                                ...
                                {paymentsData.map(payment => (
                                    ...
                                    >
                                        <td className="px-8 py-6">
                                            <span className="text-[13px] font-black text-[var(--text-primary)] uppercase tracking-tight italic group-hover:text-[var(--gold)] transition-colors">
                                                {payment.month}
                                            </span>
                                        </td>
                                        <td className="px-8 py-6">
                                        ...
                                        <td className="px-8 py-6 text-center">
                                            <span className="px-3 py-1.5 rounded-xl bg-[var(--bg-void)] border border-[var(--border-glass)] text-[10px] font-black text-[var(--text-secondary)] uppercase tracking-widest group-hover:border-[var(--gold)]/30 transition-all">
                                                {payment.method}
                                            </span>
                                        </td>
                                        <td className="px-8 py-6 text-center">
                                            <div className="flex justify-center">
                                                <span className={`flex items-center gap-2 px-4 py-1.5 rounded-full text-[9px] font-black uppercase tracking-[0.2em] shadow-lg border ${payment.status === "To'langan"
