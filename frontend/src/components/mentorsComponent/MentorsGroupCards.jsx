...
export default function MentorsGroupCards({ mentorsGroups, navig }) {
 ...
 <p className="text-[10px] font-black text-[var(--text-muted)] capitalize tracking-[0.4em] mb-2">No Strategic Units Found</p>
 <p className="text-[9px] font-bold text-[var(--text-muted)] capitalize tracking-widest opacity-40">Operational grid is currently vacant.</p>
 </div>
 );
 }
 ...
 <h4 className="text-base md:text-xl font-black text-[var(--text-primary)] tracking-tight capitalize leading-tight group-hover:text-[var(--gold)] transition-colors truncate">
 {card.name}
 </h4>
 ...
 <span className="text-[9px] font-black text-emerald-500 capitalize tracking-widest">Faol</span>
 </>
 )}
 {card.computed_status ==='waiting' && (
 <>
 <div className="w-1.5 h-1.5 rounded-full bg-amber-500 shadow-[0_0_8px_rgba(245,158,11,0.5)]"></div>
 <span className="text-[9px] font-black text-amber-500 capitalize tracking-widest">Kutilmoqda</span>
 </>
 )}
 {card.computed_status ==='activating_soon' && (
 <>
 <div className="w-1.5 h-1.5 rounded-full bg-blue-500 shadow-[0_0_8px_rgba(59,130,246,0.5)]"></div>
 <span className="text-[9px] font-black text-blue-500 capitalize tracking-widest">Yaqinda faol</span>
 </>
 )}
 {card.computed_status ==='inactive' && (
 <>
 <div className="w-1.5 h-1.5 rounded-full bg-red-500/50"></div>
 <span className="text-[9px] font-black text-red-500/50 capitalize tracking-widest">Nofaol</span>
 </>
 )}
 </div>
 </div>
 ...
 <Users size={12} />
 <span className="text-[8px] font-black capitalize tracking-widest">Soni</span>
 </div>
 <p className="text-lg md:text-2xl font-black text-[var(--text-primary)]">
 {card.students_count} <span className="text-[10px] md:text-xs not-italic opacity-30 tracking-widest capitalize ml-1">ta</span>
 </p>
 </div>
 ...
 <div className="flex items-center gap-2 mb-1.5 text-[var(--text-muted)] opacity-60">
 <Clock size={12} />
 <span className="text-[8px] font-black capitalize tracking-widest">Vaqti</span>
 </div>
 <p className="text-xs md:text-base font-black text-[var(--text-primary)] truncate">{card.dars_vaqti ||"---"}</p>
 </div>
 </div>
 ...
 <span className="text-[8px] font-black text-[var(--text-muted)] capitalize tracking-widest">Dars Kunlari</span>
 <p className="text-[10px] md:text-xs font-black text-[var(--text-primary)] capitalize mt-1 tracking-tight truncate">
