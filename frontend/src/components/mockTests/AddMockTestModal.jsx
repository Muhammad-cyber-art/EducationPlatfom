...
const AddMockTestModal = ({ isOpen, onClose, groupId }) => {
 ...
 <div>
 <h2 className="text-base font-black text-[var(--text-primary)] capitalize tracking-tight">Mock Test Yaratish</h2>
 <p className="text-[9px] text-[var(--text-secondary)] font-bold capitalize tracking-widest opacity-60">Yangi imtihon</p>
 </div>
 </div>
 <button
