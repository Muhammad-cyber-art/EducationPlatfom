...
const MockTestDetails = () => {
    ...
    if (loading) return (
        <div className="min-h-screen bg-[var(--bg-void)] flex flex-col items-center justify-center gap-4">
            ...
            <p className="text-[9px] font-black text-[var(--text-muted)] uppercase tracking-[0.3em]">Yuklanmoqda...</p>
        </div>
    );
                        ...
                        <div className="flex items-start md:items-center gap-5">
                            ...
                            <div>
                                <div className="flex items-center gap-3 mb-1">
                                    <h2 className="text-xl md:text-2xl font-bold tracking-tight uppercase">{testData.subject}</h2>
                                ...
                                <div className="flex flex-wrap items-center gap-x-4 gap-y-1">
                                    ...
                                    <p className="text-[9px] font-black text-[var(--gold)] uppercase tracking-[0.2em] italic">
                                        {testData.group_name}
                                    </p>
                                </div>
                            </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                    <div className="lux-card !p-4 flex items-center gap-3">
                        ...
                        <div className="overflow-hidden">
                            <p className="text-[8px] font-black text-[var(--text-muted)] uppercase tracking-wider truncate text-ellipsis">O'quvchilar</p>
                    ...
                    <div className="lux-card !p-4 flex items-center gap-3">
                        ...
                        <div className="overflow-hidden">
                            <p className="text-[8px] font-black text-[var(--text-muted)] uppercase tracking-wider truncate text-ellipsis">O'zlashtirish</p>
                    ...
                    <div className="lux-card !p-4 col-span-2 md:col-span-1 flex items-center gap-3">
                        ...
                        <div className="overflow-hidden">
                            <p className="text-[8px] font-black text-[var(--text-muted)] uppercase tracking-wider truncate text-ellipsis">Holati</p>
                ...
                <div className="lux-card !p-0 overflow-hidden shadow-xl border border-[var(--border-glass)]">
                    <div className="px-6 py-5 md:px-10 md:py-6 border-b border-[var(--border-glass)] bg-[var(--bg-panel)]/30 flex flex-col sm:flex-row items-center justify-between gap-4">
                        <div className="flex items-center gap-4 w-full sm:w-auto">
                            ...
                            <div>
                                <h3 className="text-sm md:text-base font-bold text-[var(--text-primary)] tracking-tight uppercase">Natijalar</h3>
                                <p className="text-[8px] font-bold text-[var(--text-muted)] uppercase tracking-[0.2em] hidden sm:block">Ballarni tahrirlash</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center flex-wrap justify-center sm:justify-end gap-3 w-full sm:w-auto">
                            <div className="flex items-center gap-1.5 bg-[var(--bg-void)]/50 p-1 rounded-lg border border-[var(--border-glass)]">
                                ...
                                <button
                                    ...
                                    className="h-6 px-2 bg-[var(--gold-dim)] text-[var(--gold)] hover:bg-[var(--gold)] hover:text-black transition-all rounded-md text-[8px] font-black uppercase tracking-wider"
                                >
                                    OK
                                </button>
                            </div>
                    ...
                    {students.length === 0 && (
                        <div className="text-center py-16 text-[var(--text-muted)] font-black uppercase tracking-[0.2em] italic text-[10px]">
